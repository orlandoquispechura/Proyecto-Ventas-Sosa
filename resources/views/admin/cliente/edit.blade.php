    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="dni" id="dni" min="0" value="{{ old('dni', $cliente->dni) }}" class="form-control"
                    tabindex="4">
                @if ($errors->has('dni'))
                    <div class="alert alert-danger">
            ...
            <div class="form-group">
                ...
                <textarea name="direccion" id="direccion" class="form-control"
                    tabindex="5">{{ old('direccion', $cliente->direccion) }}</textarea>
            ...
            <button type="submit" class="btn btn-success mr-2 " tabindex="8">Actualizar </button>
            <a href="{{ route('admin.clientes.index') }}" class="btn btn-secondary" tabindex="9">Cancelar</a>
