    ...
    <div class="card-body">
        <form action="{{url('/proveedors')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="razon_social" id="razon_social" value="{{ old('razon_social')}}" class="form-control" tabindex="1" autofocus>
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" id="email" value="{{ old('email')}}" class="form-control" tabindex="3">
                @if($errors->has('email'))
            ...
            <a href="{{route('proveedors.index')}}" class="btn btn-secondary ml-2" tabindex="7">Cancelar</a>
    </div>
    </form>
</div>
</div>
