    ...
    <div class="card-body">
        <form action="{{url('/articulos')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="precio_venta" id="precio_venta" value="precio_venta" class="form-control" tabindex="4">
                @if($errors->has('precio_venta'))
                <span class="error text-danger">{{$errors->first('precio_venta')}}</span>
                @endif
            </div>
            <div class="form-group">
                <label for="categoria_id" class="text-blue" tabindex="5">Categoría: </label>
